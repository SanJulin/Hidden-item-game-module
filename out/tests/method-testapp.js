...
const computer = new computer_1.default(3, [{ name: 'police' }, { name: 'doctor' }, { name: 'pilot' }, { name: 'developer' }, { name: 'teacher' }, { name: 'administrator' }, { name: 'actor' }, { name: 'chef' }]);
...
const computerRow = new computer_row_1.default(5, [{ name: 'police' }, { name: 'doctor' }, { name: 'pilot' }, { name: 'developer' }, { name: 'teacher' }, { name: 'administrator' }, { name: 'actor' }, { name: 'chef' }]);
